...
export default function AuthoringMetaPanel({ detail, loading, onClose, settings, onUpdated, parentTitle }: Props) {
            ...
            {loading
              ...
              : <>
                  <div>
                    ...
                    {editing && <span className="badge badge-amber" style={{ marginLeft: 8 }}>편집 중</span>}
                  </div>
